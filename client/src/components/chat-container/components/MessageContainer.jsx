...
const MessageContainer = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-[10px] sm:p-4 sm:px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full pb-4" style={{ overscrollBehavior: 'contain', WebkitOverflowScrolling: 'touch' }}>
      {renderMessages()}
      <div ref={scrollRef} />
