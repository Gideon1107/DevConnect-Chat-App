  ...
  return (
    ...
    <nav className=" w-full bg-slate-900/95 backdrop-blur-sm border-b border-slate-800 z-50">
      <div className="px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] ">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              to="/docs"
              className={`text-gray-300 hover:text-white px-3 py-2 rounded-md text-base ${
                location.pathname === '/docs' ? 'text-white' : ''
              }`}
            >
              Docs
            </Link>
        ...
        {/* Mobile menu */}
      <div className={` text-white absolute top-[64px]  bg-slate-900 w-full py-8 transition-all duration-500 ease-out overflow-hidden ${isMenuOpen ? "max-h-[300px] opacity-100" : "max-h-0 opacity-0 hidden" }`}>
