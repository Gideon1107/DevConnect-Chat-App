...
export const Navbar = ({ onSignInClick }) => {
  ...
  return (
    <>
      <div className="py-5 sm:py-5 flex items-center w-full justify-between bg-slate-900 backdrop-blur-sm sm:border-b border-slate-800 z-[9999] sticky top-0 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]">
      ...
      {/* Mobile menu */}
      <div className={`z-[9998] text-white fixed top-[64px] left-0 bg-slate-900 backdrop-blur-sm w-full border-b-[1px] border-slate-800 transition-all duration-500 ease-in-out  ${isMenuOpen ? "max-h-[600px] opacity-100 py-8" : "max-h-0 opacity-0 overflow-hidden "}`}>
