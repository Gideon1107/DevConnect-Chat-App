...
const ConfirmDelete = ({ setIsModalOpen, setSelectedImage}) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/70 bg-slate-900 flex items-center justify-center z-50">
            <div className="bg-slate-900 p-4 rounded-[8px] w-full max-w-sm sm:border border-slate-800 flex flex-col scale-100 gap-5 duration-300 transition-all ">
