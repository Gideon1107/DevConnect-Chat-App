...
export const VERIFY_SIGNUP = `${AUTH_ROUTES}/activate`;
export const LOGIN_ROUTE = `${AUTH_ROUTES}/login`;
export const GOOGLE_LOGIN_ROUTE = `${AUTH_ROUTES}/google`;
export const CHECK_AUTH_ROUTE = `${AUTH_ROUTES}/check`;
export const LOGOUT_ROUTE = `${AUTH_ROUTES}/logout`;

export const PASSWORD_RESET_REQUEST_ROUTE = `${AUTH_ROUTES}/request-reset`;
export const PASSWORD_RESET_ROUTE = `${AUTH_ROUTES}/reset-password`;
